  ...
  <div class="mx-4 md:mx-12 lg:mx-24">
    ...
    <div class="my-4">
      <p class="text-sm md:text-base">
        This is the overview board of the Cologne Zoo. It can be used by zookeepers to get an
        overview of the animals and their relevant health data.
      </p>
      <p class="text-sm md:text-base mt-2">
        Please contact the zoo admin at "admin [at] zoo-cologne [dot] de" for support with the
        dashboard. Cyber-Attacks from the Duisburg Zoo have become more frequent on the past, so be
        on the lookout.
      </p>
    </div>
