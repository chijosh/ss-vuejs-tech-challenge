...
Check Readme for instrutions. [Changelog](README.md)
...
Check changelog for changes. [Changelog](CHANGELOG.md)
...
Check changelog `v0.0.4` for changes. [Changelog](CHANGELOG.md)
...
Check changelog `v0.0.5` for changes. [Changelog](CHANGELOG.md)
...
Check changelog `v0.0.6` for changes. [Changelog](CHANGELOG.md)
